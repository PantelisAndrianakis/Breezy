...
RT_SRC  = runtime/alloc.c runtime/print.c runtime/string.c runtime/array.c runtime/map.c runtime/vector.c runtime/clock.c runtime/random.c runtime/exception.c runtime/regex.c runtime/coroutine_win.c runtime/sched.c runtime/map_entry.c runtime/channel.c runtime/file.c runtime/timer.c
...
lib_breezy.a: $(RT_SRC) $(RT_HDR)
	...
	ar rcs lib_breezy.a runtime/alloc.o runtime/print.o runtime/string.o runtime/array.o runtime/map.o runtime/vector.o runtime/clock.o runtime/random.o runtime/exception.o runtime/regex.o runtime/coroutine_win.o runtime/sched.o runtime/map_entry.o runtime/channel.o runtime/file.o runtime/timer.o runtime/entry.o
