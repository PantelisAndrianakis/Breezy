...
check list_set_front tests/samples/proj_list_set_front $'100\n5\n400'
check_abort list_set_oob tests/samples/bad_list_set_oob.bzy
...
check alt_spellings tests/samples/alt_spellings.bzy $'false\ntrue\ntrue\ntrue\ntrue\ntrue'
...
check mc_string   tests/samples/proj_mc_string     $'15000'
